$(document).ready(function () {
...

    {
        ...
        "tran vu van trang": {
            "wish": "Chúc m luôn mạnh khỏe , thành công trong cuộc sống, sớm có thể đi khắp thế giới, luôn đạt được những gì xứng đáng với mình. :)",
            "videoId": "HXkh7EOqcQ4"
        }
    }
    ...
    function getPexelData() {
        ...
        var url = `https://api.pexels.com/v1/search?query=${ usrWant.length > 0 ? usrWant : 'bouquet' }&per_page=15&page=${randomPage}`;
        //console.log(url);
        $.ajax({
            headers: {
